...
function PedimentMaterial( gl, onload ) {
    Material.call( this, 'pediment', gl, onload );
}

PedimentMaterial.prototype = {
    constructor: 'PedimentMaterial',
    textureObject: null,
    downloadData: function( callback ) {
        ...
        img.src = 'materials/pediment/pediment.jpg';
    },
